...
"%~dp0_tools\_apps\Backup-Start-Menu-Layout\BackupSML.exe" /C "%~dp0_user-files\_tweaks\_start-menu-layouts\start-menu-layout_%datetime%"
...
rem dusable Search bar from Taskbar
...
if UILanguage==0419 (
	"%~dp0_tools\_apps\Backup-Start-Menu-Layout\BackupSML.exe" /R "%~dp0_tools\_apps\Backup-Start-Menu-Layout\MenuLayouts\Default_StartMenu_Ru\"
) else (
	"%~dp0_tools\_apps\Backup-Start-Menu-Layout\BackupSML.exe" /R "%~dp0_tools\_apps\Backup-Start-Menu-Layout\MenuLayouts\Default_StartMenu_En\"
)
