...
- Изменения настроек можно гарантированно откатить, вернувшись к [Точке восстановления системы](https://learn.microsoft.com/ru-ru/windows/win32/sr/restore-points), автоматически созданной до применения настроек.
